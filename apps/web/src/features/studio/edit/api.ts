...
export function getStudioDetail(storeId: string) {
...
export function updateStudio(storeId: string, body: StoreUpdateRequest) {
    return clientApiFetch<StoreUpdateResult>(`${BASE}/stores/${storeId}`, {
        method: 'PATCH',
        body,
    });
}
...
export function requestImageUpload(storeId: string, body: StoreImageUploadRequest) {
    return clientApiFetch<StoreImageUploadResult>(`${BASE}/stores/${storeId}/images`, {
        method: 'POST',
        body,
    });
}
...
export function confirmImageUpload(storeId: string, imageId: string) {
    return clientApiFetch<StoreImageConfirmResult>(
...
export function deleteImage(storeId: string, imageId: string) {
    return clientApiFetch<null>(`${BASE}/stores/${storeId}/images/${imageId}`, {
        method: 'DELETE',
    });
}
