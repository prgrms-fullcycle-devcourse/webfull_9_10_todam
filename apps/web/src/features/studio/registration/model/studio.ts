...
function initialForm(): StudioRegistrationForm {
    return {
        business: {
            documentUrl: null,
            businessNumber: '',
...
interface StudioRegistrationStore {
    step: StoreRegistrationStep;
    form: StudioRegistrationForm;
    ...
    patchReservation: (p: Patch<StudioRegistrationForm['reservation']>) => void;
    reset: () => void;
}

export const useStudioRegistrationStore = create<StudioRegistrationStore>((set) => ({
...
export function isStepValid(form: StudioRegistrationForm, step: StoreRegistrationStep): boolean {
    switch (step) {
...
export function isDirty(form: StudioRegistrationForm): boolean {
    return JSON.stringify(form) !== JSON.stringify(initialForm());
}

export function isAllValid(form: StudioRegistrationForm): boolean {
    return (
