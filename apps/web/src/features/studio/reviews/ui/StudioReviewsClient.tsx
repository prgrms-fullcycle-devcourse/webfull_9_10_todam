...
import { usePublicStudioName, useStudioReviewsInfinite } from '../queries';
...
export function StudioReviewsClient() {
    ...
    const storeQuery = usePublicStudioName(slug);
    const reviewsQuery = useStudioReviewsInfinite(slug, sort);
